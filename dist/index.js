...
function Content() {
    ...
    return (SP_JSX.jsxs(SP_JSX.Fragment, { children: [SP_JSX.jsxs(DFL.PanelSection, { title: "Overview", children: [SP_JSX.jsx(SelectableInfoRow, { label: SP_JSX.jsxs("span", { style: { display: "flex", alignItems: "center", gap: 8 }, children: [SP_JSX.jsx(FaGamepad, {}), " Current activity"] }), children: SP_JSX.jsx("div", { style: summaryCardStyle("rgba(68, 200, 255, 0.45)"), children: SP_JSX.jsxs("div", { style: { display: "flex", gap: 10, alignItems: "center" }, children: [currentGameArt ? SP_JSX.jsx("img", { src: currentGameArt, alt: currentGameLabel, style: { width: 64, height: 30, objectFit: "cover", borderRadius: 8 } }) : null, SP_JSX.jsxs("div", { style: { minWidth: 0 }, children: [SP_JSX.jsx("div", { style: { fontWeight: 700, marginBottom: 6 }, children: currentGameLabel }), SP_JSX.jsxs("div", { style: { display: "flex", gap: 6, flexWrap: "wrap" }, children: [SP_JSX.jsx("span", { style: chipStyle("rgba(68, 200, 255, 0.18)"), children: contextLabel(data.state) }), SP_JSX.jsx("span", { style: chipStyle("rgba(255, 215, 0, 0.18)"), children: labelize(currentMode) }), data.state.active_game?.steam_appid ? SP_JSX.jsx("span", { style: chipStyle("rgba(255, 255, 255, 0.12)"), children: "Steam" }) : null] })] })] }) }) }), SP_JSX.jsx(SelectableInfoRow, { label: SP_JSX.jsxs("span", { style: { display: "flex", alignItems: "center", gap: 8 }, children: [SP_JSX.jsx(FaBullseye, {}), " FPS target"] }), children: SP_JSX.jsxs("div", { style: summaryCardStyle("rgba(120, 255, 160, 0.45)"), children: [SP_JSX.jsxs("div", { style: { fontWeight: 700, marginBottom: 6 }, children: [liveFps, " / ", targetFps, " fps"] }), SP_JSX.jsxs("div", { style: { display: "flex", gap: 6, flexWrap: "wrap" }, children: [SP_JSX.jsxs("span", { style: chipStyle("rgba(120, 255, 160, 0.18)"), children: ["Current ", liveFps] }), SP_JSX.jsxs("span", { style: chipStyle("rgba(120, 255, 160, 0.18)"), children: ["Target ", targetFps, " fps"] }), data.state.fps_target_unreachable ? SP_JSX.jsx("span", { style: chipStyle("rgba(255, 120, 120, 0.18)"), children: "Auto-capped" }) : null] })] }) }), SP_JSX.jsx(SelectableInfoRow, { label: SP_JSX.jsxs("span", { style: { display: "flex", alignItems: "center", gap: 8 }, children: [SP_JSX.jsx(FaTachometerAlt, {}), " Power state"] }), children: SP_JSX.jsxs("div", { style: summaryCardStyle("rgba(255, 180, 80, 0.45)"), children: [SP_JSX.jsxs("div", { style: { fontWeight: 700, marginBottom: 6 }, children: [data.state.current_tdp ?? resolved.ACTIVE_DEFAULT_TDP, " mW"] }), SP_JSX.jsxs("div", { style: { display: "flex", gap: 6, flexWrap: "wrap" }, children: [SP_JSX.jsxs("span", { style: chipStyle("rgba(255, 180, 80, 0.18)"), children: ["CPU ", data.state.cpu_usage, "%"] }), SP_JSX.jsxs("span", { style: chipStyle("rgba(255, 180, 80, 0.18)"), children: ["Min ", quickMinTdp, " mW"] }), SP_JSX.jsxs("span", { style: chipStyle("rgba(255, 180, 80, 0.18)"), children: ["Default ", quickDefaultTdp, " mW"] }), SP_JSX.jsxs("span", { style: chipStyle("rgba(255, 180, 80, 0.18)"), children: ["Ceiling ", quickMaxTdp, " mW"] }), SP_JSX.jsx("span", { style: chipStyle("rgba(255, 180, 80, 0.18)"), children: data.state.ryzenadj.active_source ? labelize(data.state.ryzenadj.active_source) : "No ryzenadj" })] })] }) }), SP_JSX.jsx(SelectableInfoRow, { label: SP_JSX.jsxs("span", { style: { display: "flex", alignItems: "center", gap: 8 }, children: [SP_JSX.jsx(FaBatteryHalf, {}), " Battery"] }), children: SP_JSX.jsxs("div", { style: summaryCardStyle("rgba(170, 120, 255, 0.45)"), children: [SP_JSX.jsx("div", { style: { fontWeight: 700, marginBottom: 6 }, children: batterySummary(data.state) }), SP_JSX.jsxs("div", { style: { display: "flex", gap: 6, flexWrap: "wrap" }, children: [SP_JSX.jsx("span", { style: chipStyle("rgba(170, 120, 255, 0.18)"), children: data.state.external_power ? "Plugged in" : "Battery / unknown" }), SP_JSX.jsx("span", { style: chipStyle("rgba(170, 120, 255, 0.18)"), children: data.state.focus ?? "No focus data" })] })] }) })] }), SP_JSX.jsxs(DFL.PanelSection, { title: "Runtime Control", children: [SP_JSX.jsx(DFL.PanelSectionRow, { children: SP_JSX.jsx(DFL.ToggleField, { label: SP_JSX.jsxs("span", { style: { display: "flex", alignItems: "center", gap: 8 }, children: [SP_JSX.jsx(FaBolt, {}), " Enable AutoTDP"] }), description: "Adaptive TDP loop. HHD compatibility mode disables only HHD TDP control, not buttons or controller helpers.", checked: data.settings.enabled, onChange: async (checked) => applyData(await setEnabled(checked)) }) }), SP_JSX.jsx(SelectableInfoRow, { label: "RyzenAdj status", children: data.state.ryzenadj.test_ok ? `Ready (${data.state.ryzenadj.active_source ?? "none"})` : data.state.ryzenadj.test_error ?? "Unavailable" })] }), SP_JSX.jsxs(DFL.PanelSection, { title: "Quick Settings", children: [SP_JSX.jsx(DFL.PanelSectionRow, { children: SP_JSX.jsx(DFL.DropdownItem, { label: SP_JSX.jsxs("span", { style: { display: "flex", alignItems: "center", gap: 8 }, children: [SP_JSX.jsx(FaDesktop, {}), " Device profile"] }), description: "Choose hardware baseline for handheld or laptop", rgOptions: profileOpts, selectedOption: data.settings.device_profile, onChange: async (option) => applyData(await setDeviceProfile(String(option.data))) }) }), SP_JSX.jsx(DFL.PanelSectionRow, { children: SP_JSX.jsx(DFL.DropdownItem, { label: SP_JSX.jsxs("span", { style: { display: "flex", alignItems: "center", gap: 8 }, children: [SP_JSX.jsx(FaBolt, {}), " Base mode"] }), description: "Preferred performance mode when automation does not override it", rgOptions: modes, selectedOption: data.settings.performance_mode, onChange: async (option) => applyData(await setPerformanceMode(String(option.data))) }) }), SP_JSX.jsx(DFL.PanelSectionRow, { children: SP_JSX.jsx(DFL.SliderField, { label: "Minimum TDP", description: "Lowest TDP AutoTDP may use", value: quickMinTdp, min: 2000, max: quickMaxTdp, step: 1000, showValue: true, valueSuffix: " mW", editableValue: true, onChange: async (value) => {
                            ...
                            } }) }), SP_JSX.jsx(DFL.PanelSectionRow, { children: SP_JSX.jsx(DFL.SliderField, { label: "Default TDP", description: data.settings.auto_save_game_profiles && data.state.active_game ? "Quick edit for active game profile" : "Default target while gaming", value: quickDefaultTdp, min: quickMinTdp, max: quickMaxTdp, step: Number(resolved.STEP_TDP), showValue: true, valueSuffix: " mW", editableValue: true, onChange: async (value) => {
