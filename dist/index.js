...
function AdvancedModal(props) {
    ...
    const pages = [
        ...
        },
        {
            title: "RyzenAdj",
            identifier: "ryzenadj",
            content: (SP_JSX.jsx(SP_JSX.Fragment, { children: SP_JSX.jsxs(DFL.PanelSection, { title: "Binary Source", children: [SP_JSX.jsxs(DFL.PanelSectionRow, { children: ["Selected source: ", labelize(data.state.ryzenadj.selected_source)] }), SP_JSX.jsxs(DFL.PanelSectionRow, { children: ["Active source: ", data.state.ryzenadj.active_source ? labelize(data.state.ryzenadj.active_source) : "Unavailable"] }), SP_JSX.jsx(DFL.PanelSectionRow, { children: SP_JSX.jsx(DFL.DropdownItem, { label: "RyzenAdj source", description: "Auto prefers installed system binary, then bundled, then downloaded", rgOptions: data.state.ryzenadj.sources.map((source) => ({ data: source, label: labelize(source) })), selectedOption: data.settings.ryzenadj_source, onChange: async (option) => onState(await setRyzenadjSource(String(option.data))) }) }), SP_JSX.jsxs(DFL.PanelSectionRow, { children: ["System available: ", data.state.ryzenadj.system_available ? "Yes" : "No"] }), SP_JSX.jsxs(DFL.PanelSectionRow, { children: ["Bundled available: ", data.state.ryzenadj.bundled_available ? "Yes" : "No"] }), SP_JSX.jsxs(DFL.PanelSectionRow, { children: ["Downloaded available: ", data.state.ryzenadj.downloaded_available ? "Yes" : "No"] }), SP_JSX.jsxs(DFL.PanelSectionRow, { children: ["Resolved path: ", data.state.ryzenadj.resolved_path ?? "None"] }), SP_JSX.jsx(DFL.PanelSectionRow, { children: SP_JSX.jsx(DFL.ButtonItem, { label: "Download precompiled RyzenAdj", description: "Fetch plugin-managed fallback binary", onClick: async () => onState(await downloadRyzenadj()) }) })] }) })),
        },
        {
            title: "Battery",
            identifier: "battery",
